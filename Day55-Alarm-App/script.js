...
const createAlarm = (hour, minute) => {
  ...
  deleteButton.addEventListener('click', () => deleteAlarm(alarmObject));
...
setAlarm.addEventListener('click', () => {
  ...
  if (hour < 0 || hour > 23 || minute < 0 || minute > 59) {
    alert(
      'Invalid hour or minute. Please enter values within the valid range!'
    );
    return;
  }
